...
enum Cutset { stage1cuts, novetocuts, FVsideband, allowWalls2and5, stage1cutsVetoFirst, nueFilter, tridentSelection} ;
...
int main(int argc, char ** argv) {
  ...
  if (argc != 4) {
    std::cout << "Three arguments required: input file name (or reg exp), output file name, cut set (0: stage 1 selection, 1: no veto or scifi 1st layer, 2: FV sideband, 3: include walls 2 and 5, 4: nue filter, 6: trident selection (with veto hits))." << std::endl;
    exit(-1);
  }
